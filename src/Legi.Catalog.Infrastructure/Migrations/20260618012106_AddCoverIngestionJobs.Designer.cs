...
namespace Legi.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20260618012106_AddCoverIngestionJobs")]
    partial class AddCoverIngestionJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Legi.Catalog.Domain.Entities.Work", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("DefaultCoverUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("Legi.Catalog.Infrastructure.Persistence.Entities.BookRatingEntity", b =>
                {
                    b.Property<Guid>("BookId")
                        .HasColumnType("uuid")
                        .HasColumnName("book_id");
            ...
            modelBuilder.Entity("Legi.Catalog.Infrastructure.Persistence.Entities.CoverIngestionJobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<int>("NoCoverAttempts")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.ToTable("cover_ingestion_jobs", (string)null);
                });

            modelBuilder.Entity("Legi.Catalog.Infrastructure.Persistence.Entities.ExternalBookSearchJobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("QueryHash", "CompletedAt")
                    ...
                    b.ToTable("external_book_search_jobs", (string)null);
                });
            ...
            modelBuilder.Entity("Legi.Catalog.Domain.Entities.Book", b =>
                {
                    b.HasOne("Legi.Catalog.Domain.Entities.Work", null)
                        .WithMany()
                        .HasForeignKey("WorkId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsOne("Legi.Catalog.Domain.ValueObjects.WorkKey", "WorkKey", b1 =>
                        {
