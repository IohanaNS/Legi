...
interface ProgressFormProps {
  ...
  /** Called after a successful progress update (e.g. to close a modal). */
  onSuccess?: () => void;
}

/**
 * The shared "update reading progress" form — used inline by the feed's
 * "Reading now" card and inside the book details page's Update Progress modal.
 * Posts a reading post (progress + optional note + spoiler) via useUpdateProgress.
 */
export function ProgressForm({ userBook, onSuccess }: ProgressFormProps) {
